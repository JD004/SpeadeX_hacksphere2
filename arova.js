...
const Arova = () => {
  const [messages, setMessages] = useState([
    { text: 'Welcome to Arova! How can I assist you today?', sender: 'bot' },
    ...
    <div className="flex h-screen bg-black text-white">
      ...
      <div className="w-72 bg-black p-6 hidden md:flex flex-col">
        <div className="flex items-center mb-8">
          ...
          <h2 className="ml-3 text-2xl font-semibold">Arova</h2>
        </div>
        ...
        <div className="mt-auto">
          <p className="text-sm text-gray-500">© 2025 Arova</p>
        </div>
      </div>
